...
# Pretrained model on MNIST
# Finetune the ALL layers on EMNIST
...
if __name__ == '__main__':
    ...
    # Load model pretrained on MNIST
    model.load_state_dict(torch.load("pretrained/mnist_pretraining_n_epoch=20,bs=128,lr=0.001.pth"))

    exp_name = f"pretrain_MNIST_finetune_all_layers_n_epoch={args.n_epoch},bs={args.batch_size},lr={args.lr}"
